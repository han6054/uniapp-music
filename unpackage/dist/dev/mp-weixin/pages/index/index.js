...
/* 13 */
/*!**************************************************************************************!*\
  !*** /Users/jiajunhan/Desktop/uniapp-music/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \**************************************************************************************/
...
/* 14 */
/*!*******************************************************************!*\
  !*** /Users/jiajunhan/Desktop/uniapp-music/pages/index/index.vue ***!
  \*******************************************************************/
/*! no static exports found */
...
/* 15 */
/*!**************************************************************************************************!*\
  !*** /Users/jiajunhan/Desktop/uniapp-music/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \**************************************************************************************************/
...
/* 17 */
/*!********************************************************************************************!*\
  !*** /Users/jiajunhan/Desktop/uniapp-music/pages/index/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 18 */
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/jiajunhan/Desktop/uniapp-music/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _index = __webpack_require__(/*! ../../apis/index.js */ 19); //
//
//
//
//
...
//
//
var songList = function songList() {__webpack_require__.e(/*! require.ensure | components/songList */ "components/songList").then((function () {return resolve(__webpack_require__(/*! ../../components/songList */ 54));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { songList: songList }, data: function data() {return { swiper: [], curDate: '', contentBar: [{ name: "每日推荐" }, { name: "歌单" }, { name: "排行榜" }, { name: "电台" }, { name: "直播" }], recommendSongs: [], newType: 1, // 新歌新碟
      latestTempAlbum: [], latestAlbum: [], relatedVideo: [], hotList: [] };}, onLoad: function onLoad() {this.getBanner();this.getRecommendSongs();this.getLatestAlbum();this.getRelatedVideo();this.getHotList();this.curDate = new Date().getDate();}, onPullDownRefresh: function onPullDownRefresh() {// 下拉监听事件
    console.log('refresh,下拉监听事件');setTimeout(function () {uni.stopPullDownRefresh();}, 1000);}, methods: { // 获取轮播图
    getBanner: function getBanner() {var _this = this;(0, _index.apiGetBanner)().then(function (res) {_this.swiper = res.banners;});}, // 获取推荐歌单
    getRecommendSongs: function getRecommendSongs() {var _this2 = this;var params = { limit: 6 };(0, _index.apiGetRecommendSongs)(params).then(function (res) {// 格式化播放量数据
        var formatCount = function formatCount(data) {var tempNum = data;if (data > 100000) {tempNum = parseInt(data / 10000) + '万';}return tempNum;};_this2.recommendSongs = res.result;
        _this2.recommendSongs.forEach(function (item) {
    ...
    // 获取新碟
    getLatestAlbum: function getLatestAlbum() {var _this3 = this;
      (0, _index.apiGetTopAlbum)().then(function (res) {
        _this3.latestTempAlbum = res.albums;
        _this3.latestAlbum = res.albums.slice(0, 3);
      });
    },
    // 获取相关视频
...
/* 26 */
/*!*****************************************************************************************************!*\
  !*** /Users/jiajunhan/Desktop/uniapp-music/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
